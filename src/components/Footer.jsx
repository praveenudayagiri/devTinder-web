const Footer = () =>{
    return(
        <footer className="fixed bottom-0 left-0 w-full bg-base-200 text-base-content p-4 flex flex-col items-center">
  ...
  <nav className="mt-2">
    <div className="grid grid-flow-col gap-4">
      {/* LinkedIn */}
      <a href="https://www.linkedin.com/in/praveen-udayagiri-589775259" target="_blank" rel="noopener noreferrer">
      ...
      {/* GitHub */}
      <a href="https://github.com/praveenudayagiri" target="_blank" rel="noopener noreferrer">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="fill-current">
  ...
  <aside className="mt-2">
    <p>
      Copyright © {new Date().getFullYear()} - All rights reserved by Praveen Udayagiri
    </p>
  </aside>
</footer>
